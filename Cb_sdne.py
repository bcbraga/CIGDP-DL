...
def main():
    ...
    for ru in np.arange(total_run):
        ...
        arq_sdne = open('res_sdne/Cb_SDNE_' + str(ru+1) + '.txt', 'a')
        # keep the permutation value
        arq_sdne_p = open('res_sdne/Cb_SDNE_p_' + str(ru+1) + '.txt', 'a')
        # keep the permutation value pos constructive phase
        arq_sdne_con_p = open('res_sdne/Cb_SDNE_const_p_' + str(ru+1) + '.txt', 'a')
        # keep grasp iterations
        arq_sdne_iter = open('res_sdne/Cb_SDNE_iter_' + str(ru+1) + '.txt', 'a')
