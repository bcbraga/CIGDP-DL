...
def main():
    ...
    for ru in np.arange(total_run):
        ...
        arq_cb = open('res_n2v2/Cb_n2v2_' + str(ru + 1) + '.txt', 'a')
        # keep the permutation value
        arq_cb_p = open('res_n2v2/Cb_n2v2_p_' + str(ru + 1) + '.txt', 'a')
        # keep the permutation value pos constructive phase
        arq_cb_con_p = open('res_n2v2/Cb_n2v2_const_p_' + str(ru + 1) + '.txt', 'a')
        # keep grasp iterations
        arq_cb_iter = open('res_n2v2/Cb_n2v2_iter_' + str(ru + 1) + '.txt', 'a')
